...
<div class="main" style="padding: 80px;"><!--紫色的-->
	...
	<div class="main-left">
		...
		switch($num)
		{
			case 1:$sql="select * from usarticle where look=1 and classes='流行' order by time desc";break;
			case 2:$sql="select * from usarticle where look=1 and classes='摇滚' order by time desc";break;
			case 3:$sql="select * from usarticle where look=1 and classes='民谣' order by time desc";break;
			case 4:$sql="select * from usarticle where look=1 and classes='爵士' order by time desc";break;
			case 5:$sql="select * from usarticle where look=1 and classes='原创' order by time desc";break;
			case 6:$sql="select * from usarticle where look=1 and classes='戏曲' order by time desc";break;
			case 7:$sql="select * from usarticle where look=1 and classes='独立音乐' order by time desc";break;
			case 8:$sql="select * from usarticle where look=1 order by time desc";break;
		}		
        ...
        <div class="main-left2">
        	<div class="main-left2-1">
        		<a href="sharing_open.php?articleid=<?php echo $row->articleid;?>&username=<?php echo $row->username;?>">
            	<img src="../images/userwenzhang/<?php echo $row->articleimg;?>">
            	</a>
            </div>
            <div class="main-left2-2">
            	<div class="main-left2-2-1">
                    ...
                    <div class="sharing-text3">音乐简单描述：<font face="微软雅黑" size="3" style="padding-left: 5px;"><?php echo $row->mdescribes;?></div>
                    <p class="sharing-text2">推荐人:<?php echo $row->username;?></p>
                </div>
                <div>
                	<ul class="acts_list">
        				<li class="collect">
            				<a class="wrap" href="scollecting.php?articleid=<?php echo $row->articleid;?>">
                				<span>
