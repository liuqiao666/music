...
<link href="css/own_more2.css" rel="stylesheet" type="text/css" />
       	 	...
       	 	<div class="chart_artsit">
                	<ul>
						...
						<?PHP 
						 ...
						 $sql="select * from collect where username='".$username."' and kind=1 ";
						 ...
						 ?> 
                        	<div class="chart_artsit_item">
                             <a class="buddy" href="periodical_open.php?articleid=<?php echo $row->number;?>&username=<?php echo $row->username;?>" title=""><img src="../images/adminwenzhang/<?php echo $row->img;?>" width="100" height="100"/></a>
                              <?php echo $row->name;?>
                              <div class="private_act">
                    			<a href="pcollecting.php?articleid=<?php echo $row->number;?>"><img src="images/猜你喜欢.png"></a><!--取消收藏-->
                              </div>
                            </div>
							<?php }?>  
                        </li> 
