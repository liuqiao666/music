<?php 
	...
	$mailbody="Hi ".$mailto." This is a email from 音悦 :您在网站上发布的文章已被管理员审核，恭喜您获得20积分的奖励。谢谢您的分享，网站维护人员致上^-^";
	...
	fwrite($fp,"quit".$CRLF); 
	$temp=fgets($fp,512);
	echo "<script>alert('消息已发送成功!');location.href='javascript:history.go(-1)';</script>;";
	fclose($fp);
