...
<div id="urHere">音悦分享后台管理中心<b>></b><strong>文章列表</strong></div>   <div id="manager" class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
   <h3><a href="addarticle.php" class="actionBtn">添加文章</a>文章列表
	...
	//3.写SQL代码
	$sql="select *from adarticle order by articleid desc";
    ...
    <tr>
      ...
      <td align="center"><?php echo $row->musicdescribes;?></td>
      <td align="center"><?php echo $row->classes;?></td>
      <td align="center"><img width="150px" height="150px" src="../images/adminwenzhang/<?php echo $row->articleimg;?>"></td>
      <td align="center"><?php echo $row->time;?></td>
      <td align="center"><?php echo $row->collect;?></td>
      <td align="center">     	
      	<a href="editadminarticle.php?articleid=<?php echo $row->articleid;?>" class="btn">编辑</a> 
      	<a href="shanadminarticle.php?articleid=<?php echo $row->articleid;?>" onclick="return confirm('确认删除?!');" class="btn">删除</a>
      </td>
    </tr>
    <?php 
	}
