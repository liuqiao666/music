...
<?php include("side.php"); ?>
 <div id="dcMain">
   <!-- 当前位置 -->
<div id="urHere">音悦分享后台管理中心<b>></b><strong>编辑未审核文章</strong> </div>   <div class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
  <h3>编辑未审核文章</h3>
...
if(isset($_POST['submit']))
{
	...
	$sql="update usarticle set name='".$name."',mdescribes='".$mdescribes."',classes='".$classes."',adescribes='".$adescribes."' where articleid='".$id."'";
 	...
 	if($result)
 	{
     	echo "<script>alert('音乐分享文章已成功修改!');location.href='auditlookarticle.php?articleid=$id';</script>;";
    }
 	else
     	echo "<script>alert('音乐分享文章修改失败!');location.href='auditlookarticle.php?articleid=$id';</script>;";	
}
?>
<?php
if(isset($_POST['xgtp']))
